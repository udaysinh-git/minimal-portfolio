    ...
    `<div style="position: relative; padding-left: 3rem; margin-bottom: 2rem; z-index: 1;">`
      ...
      `<div style="padding-bottom: 0.5rem;">`
        `<div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: flex-start; margin-bottom: 0.5rem;">`
          ...
          `</div>`
          `<span style="color: var(--text-muted-color); font-size: 0.9rem; font-weight: 500;">`May 2025 - Present
        `</div>`
        `<p style="margin: 0.3rem 0; color: var(--text-muted-color); font-size: 0.9rem;">`Internship • Pune, Maharashtra (Remote)`</p>`
        `<div style="margin-top: 0.8rem;">`
          `<span style="background: var(--tag-background-color); color: var(--tag-text-color); padding: 0.3rem 0.8rem; border-radius: 15px; font-size: 0.85rem; margin-right: 0.5rem; display: inline-block; margin-bottom: 0.3rem;">`Front-End Development
          `<span style="background: var(--tag-background-color); color: var(--tag-text-color); padding: 0.3rem 0.8rem; border-radius: 15px; font-size: 0.85rem; display: inline-block; margin-bottom: 0.3rem;">`Back-End Development
        `</div>`
      `</div>`
    `</div>`
    ...
    `<div style="position: relative; padding-left: 3rem; margin-bottom: 2rem; z-index: 1;">`
      ...
      `<div style="padding-bottom: 0.5rem;">`
        `<div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: flex-start; margin-bottom: 0.5rem;">`
          ...
          `</div>`
          `<span style="color: var(--text-muted-color); font-size: 0.9rem; font-weight: 500;">`Mar 2024 - Sep 2024
        `</div>`
        ...
        `<div style="margin-top: 0.8rem;">`
          `<span style="background: var(--tag-background-color); color: var(--tag-text-color); padding: 0.3rem 0.8rem; border-radius: 15px; font-size: 0.85rem; margin-right: 0.5rem; display: inline-block; margin-bottom: 0.3rem;">`AI Engineering
          `<span style="background: var(--tag-background-color); color: var(--tag-text-color); padding: 0.3rem 0.8rem; border-radius: 15px; font-size: 0.85rem; margin-right: 0.5rem; display: inline-block; margin-bottom: 0.3rem;">`Healthcare Analytics
          `<span style="background: var(--tag-background-color); color: var(--tag-text-color); padding: 0.3rem 0.8rem; border-radius: 15px; font-size: 0.85rem; display: inline-block; margin-bottom: 0.3rem;">`Data Pipelines
        `</div>`
      `</div>`
    `</div>`
    ...
    `<div style="position: relative; padding-left: 3rem; z-index: 1;">`
      ...
      `<div style="padding-bottom: 0.5rem;">`
        `<div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: flex-start; margin-bottom: 0.5rem;">`
          ...
          `</div>`
          `<span style="color: var(--text-muted-color); font-size: 0.9rem; font-weight: 500;">`Dec 2020 - Apr 2022
        `</div>`
        `<p style="margin: 0.3rem 0; color: var(--text-muted-color); font-size: 0.9rem;">`Self-employed • 1 yr 5 mos • India`</p>`
        `<div style="margin-top: 0.8rem;">`
          `<span style="background: var(--tag-background-color); color: var(--tag-text-color); padding: 0.3rem 0.8rem; border-radius: 15px; font-size: 0.85rem; margin-right: 0.5rem; display: inline-block; margin-bottom: 0.3rem;">`Game Development
          `<span style="background: var(--tag-background-color); color: var(--tag-text-color); padding: 0.3rem 0.8rem; border-radius: 15px; font-size: 0.85rem; display: inline-block; margin-bottom: 0.3rem;">`Artificial Intelligence
        `</div>`
      `</div>`
    `</div>`
...
<div style="position: relative; margin: 2rem 0; padding: 1.5rem;">
      ...
      `<div style="margin-bottom: 2rem;">`
        `<div style="font-family: monospace; line-height: 1.4; color: var(--text-color);">`
          `<div style="margin-bottom: 0.8rem;">`
            `<span style="color: var(--link-color); font-weight: bold;">`▶
            `<span style="color: var(--text-color); font-weight: 600;">`AI/ML Engineering
            `<span style="color: var(--text-muted-color); margin-left: 1rem;">`// Building intelligent systems
          `</div>`
          `<div style="margin-bottom: 0.8rem;">`
            `<span style="color: var(--link-color); font-weight: bold;">`▶
            `<span style="color: var(--text-color); font-weight: 600;">`Backend Architecture
            `<span style="color: var(--text-muted-color); margin-left: 1rem;">`// Scalable system design
          `</div>`
          `<div style="margin-bottom: 1.5rem;">`
            `<span style="color: var(--link-color); font-weight: bold;">`▶
            `<span style="color: var(--text-color); font-weight: 600;">`Cybersecurity
            `<span style="color: var(--text-muted-color); margin-left: 1rem;">`// Protecting digital assets
          `</div>`
        `</div>`
      `</div>`
    ...
    `<!-- Current Project with Arrow Flow -->`
      `<div style="display: flex; align-items: center; flex-wrap: wrap; gap: 0.5rem;">`
        `<span style="color: var(--text-muted-color); font-family: monospace; font-size: 1.1rem;">`└─
        `<span style="color: var(--text-color);">`Currently building
        `<span style="color: var(--text-muted-color); font-family: monospace;">`→
...
<div style="position: relative; margin: 2rem 0; padding: 1.5rem;">
    ...
    `<div style="position: relative; z-index: 2; background: var(--background-color); padding: 0.5rem;">`
      ...
      `<div style="display: flex; flex-wrap: wrap; align-items: center; gap: 1rem; margin-bottom: 1.5rem;">`
        `<div style="display: flex; align-items: center; gap: 0.5rem;">`
          `<span style="color: var(--text-muted-color); font-family: monospace;">`┌─
          `<span style="color: var(--text-color);">`Dive into my
          `<span style="color: var(--text-muted-color); font-family: monospace;">`→
    ...
    `<div style="display: flex; flex-wrap: wrap; align-items: center; gap: 1rem;">`
        `<div style="display: flex; align-items: center; gap: 0.5rem;">`
          `<span style="color: var(--text-muted-color); font-family: monospace;">`└─
          `<span style="color: var(--text-color);">`Read my latest
          `<span style="color: var(--text-muted-color); font-family: monospace;">`→
