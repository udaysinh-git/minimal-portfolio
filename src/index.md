...
<div style="position: relative; margin: 2rem 0; padding: 1.5rem;">
    ...
    <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 1rem;">
        <div style="display: flex; align-items: center; gap: 0.5rem;">
          ...
          <span style="color: var(--text-muted-color); font-family: monospace;">→</span>
          <a href="/blog" class="explore-link" style="color: var(--link-color); text-decoration: none; font-weight: 600; padding: 0.3rem 0.8rem; border: 1px solid var(--link-color); border-radius: 4px; font-family: monospace; white-space: nowrap;">blog.posts</a>
        </div>
      </div>
